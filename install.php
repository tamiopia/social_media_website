...
if (isset($_POST['submit'])) {
  ...
  $structure = "
    ...
    CREATE TABLE `posts` (
      ...
      `is_pushed` enum('0','1') NOT NULL DEFAULT '0',
      `pinner_id` int(10) UNSIGNED DEFAULT NULL,   
      `pusher_message` text DEFAULT NULL,         
      `is_pinner_approved` enum('0','1') NOT NULL DEFAULT '0',
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
